...
- Ongoing support after 30-day period (see [Enterprise Support](pricing#3-enterprise-support))
...
[Learn More →](pricing#3-enterprise-support)
...
Yes. Our [Blueprint Package](pricing#2-uapk-blueprint-package) ($5K-$10K) delivers the design and architecture first. Then you can choose to implement yourself or proceed to a full pilot.
...
See our [47ers Library](../47ers) for pre-built templates.
...
- [Pricing Overview](pricing) - All engagement options
- [Enterprise Overview](.) - Use cases and customer stories
- [Support Options](support) - Ongoing support details
- [Quickstart](../quickstart) - Self-host the open-source version
