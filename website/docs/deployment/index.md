...
- **Single VM** - Simple deployment on a single virtual machine - [Single VM](single-vm.md)

- **Caddy (Recommended)** - HTTPS reverse proxy with automatic certificates - [Caddy Setup](caddy.md)

- **Backups** - Database and configuration backup strategies - [Backups](backups.md)

- **Monitoring** - Observability and alerting setup - [Monitoring](monitoring.md)
