...
Instead of creating a custom manifest, you can load production-ready templates from our [47ers Library](47ers):
...
- [47ers Library](47ers) - Pre-built templates for legal, finance, and compliance workflows
- [Quickstart](quickstart) - Full setup guide
- [API Reference](api) - Complete API docs
- [Operator Guide](operator) - Managing approvals
- [Concepts](concepts) - Architecture deep dive
